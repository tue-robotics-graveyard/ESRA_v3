...
// Remove least significant byte and use most significant bit for rounding
...
void read_Calipers(){
  ...
  while(buffer_index<bytes_read){
    ...
    case 3:
      ...
      data_nibble&=0x0F00;
      caliper|=data_nibble;
      miso_packet.caliper_1=caliper;
      break;
    case 7:
      data_nibble<<=8;
      data_nibble&=0x0F00;
      caliper|=data_nibble;
      miso_packet.caliper_2=caliper;
      break;
    }
    buffer_index++;
  }
